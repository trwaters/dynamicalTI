...
### RW runs
Here is an animated version of Figure 3 in the paper, showing how the outflow can climb the S-curve starting from a stable location on the cold branch of the S-curve.  This illustrates one of the key ideas of the paper --- that a simple rise in the flux is sufficient to turn the wind from a stable solution to an unstable one.  For more information, see Section 3.2 of the paper.  
