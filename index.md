...
### RW runs
Here is a movie of the initial evolution starting from a stable location on the cold branch of the S-curve.  This illustrates one of the key ideas of the paper --- that a simple rise in the flux is sufficient to turn the wind from a stable solution to an unstable one.  
